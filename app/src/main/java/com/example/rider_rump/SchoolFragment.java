...
public class SchoolFragment extends Fragment implements View.OnClickListener {
    ...
    int[] images = {R.drawable.learn_skateboard, R.drawable.learn_samokat, R.drawable.learn_bycecle};
...
//        frag2 = new School_scooter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewPager mViewPager = (ViewPager)rootView.findViewById(R.id.viewPagerMain);
